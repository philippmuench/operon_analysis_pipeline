# Step 13c: Operon Sequence Extraction and Multiple Sequence Alignment
...
### Input Requirements
- BLAST results from step 13b: `../13b_blast_search/output/blast_results/`
...
python operon_pipeline.py extract-sequences --blast-dir ../13b_blast_search/output/blast_results \
...
python operon_pipeline.py extract-sequences --require-complete \
    --blast-dir ../13b_blast_search/output/blast_results \
    --assemblies-dir ../../Efs_assemblies --output-dir output/sequences
```
