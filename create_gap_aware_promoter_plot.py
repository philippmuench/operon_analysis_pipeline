...
def main():
    parser = argparse.ArgumentParser(description="Create gap-aware promoter conservation plot")
    parser.add_argument("--msa-file", 
                       default="output/msa/noncoding_alignments/promoter_aligned.fasta",
                       help="Path to promoter MSA file")
    parser.add_argument("--output-file", 
                       default="output/plots/gap_aware_promoter_conservation.png",
                       help="Output plot file")
    parser.add_argument("--pribnow-start", type=int, default=43,
                       help="Pribnow box start position")
    parser.add_argument("--pribnow-end", type=int, default=50,
                       help="Pribnow box end position")
    
    args = parser.parse_args()
    
    create_gap_aware_plot(args.msa_file, args.output_file, 
                         args.pribnow_start, args.pribnow_end)
